...
public class EpiModel2Patch {
    ...
    public void setInitParams()
    {
        ...
        double beta = 0.6; params.add(beta); estParams.add(0);
        double alphaFocal = 0.14; params.add(alphaFocal); fixedParams.add(1);
        double alphaGlobal = 0.14; params.add(alphaGlobal); fixedParams.add(2);
        double deltaFocal = 6.0/12.0; params.add(deltaFocal); fixedParams.add(3);
        double deltaGlobal = 0.0/12.0; params.add(deltaGlobal); fixedParams.add(4);
        double M = 1.0/1000.0; params.add(M); estParams.add(5); // assumes symmetric import and export rates
...
//        currInits = this.fastSim(currInits, dt, length);
        ...
        double initS1 = 1575447.144; currInits.add(initS1);
        double initS2 = 1601429.756; currInits.add(initS2);
        double initI1 = 938.812; currInits.add(initI1);
        double initI2 = 1371.196; currInits.add(initI2);
        double initN1 = 5.0e06; currInits.add(initN1);
        double initN2 = 5.0e06; currInits.add(initN2);
